...
use App\Service\Organisation\OrganisationProjectNoteManager;
...
#[Route('/api/app/organisations/{idOrganisation}/projects/{idProject}/notes', requirements: ['idOrganisation' => '[a-z0-9-]+', 'idProject' => '[a-z0-9-]+'])]
#[OA\Tag(name: 'Organisation.Project')]
#[Security(name: 'JWT')]
class OrganisationProjectNoteController extends AbstractCoreController
{
    public function __construct(OrganisationProjectNoteManager $manager)
    {
